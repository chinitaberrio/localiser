...
void
LinearFilter::AddAbsolutePosition(Eigen::Vector3d& observation, Eigen::Matrix3d& covariance, ros::Time stamp) {
...
void
LinearFilter::update(Eigen::Vector3d &observation,
  ...
  */
  ...
  Eigen::Matrix3d Sc = S.llt().matrixU();
...
void
LinearFilter::predict(Eigen::Vector2d input_state, Eigen::Matrix2d input_state_variance) {
...
Eigen::Vector3d
LinearFilter::vehicle_model(Eigen::Vector3d &mean, Eigen::Vector2d &input_state){
...
Eigen::Vector3d
LinearFilter::observation_model(Eigen::Vector3d state, Eigen::Vector3d observation){
...
Eigen::Matrix3d
LinearFilter::transition_matrix_fn(Eigen::Vector3d mean, Eigen::Vector2d input_state) {

//    generate covariance transition matrix
//    mean[x, y, theta]
//    input_state[delta_p, delta_theta]

  Eigen::Matrix3d posterior;
...
Eigen::MatrixXd
LinearFilter::jacobian_matrix_fn(Eigen::Vector3d mean, Eigen::Vector2d input_state) {
